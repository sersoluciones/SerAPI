        ...
        where TUser : class
    {
        ...
        public virtual async Task ValidateAsync(ResourceOwnerPasswordValidationContext context)
        {
            ...
            if (user != null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //if (typeof(TUser) == typeof(ApplicationUser))
                    //{
                    //    var usuario = user as ApplicationUser;
                    //    context.Result = new GrantValidationResult(
                    //      subject: sub,
                    //      authenticationMethod: AuthenticationMethods.Password,
                    //      claims: GetUserClaims(usuario);
                    //}
        ...
        public static Claim[] GetUserClaims(ApplicationUser user)
        {
            return new Claim[]
            {
                ...
                new Claim(JwtClaimTypes.Name, (!string.IsNullOrEmpty(user.Name) && !string.IsNullOrEmpty(user.LastName)) ? (user.Name + " " + user.LastName) : ""),
